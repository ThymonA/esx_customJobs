function CreateJob(name, label, whitelisted, members, permissions, webhooks, grades, positions, accounts, items, weapons, buyableItems, clothes, menu, permissionSystem, version)
    local self = {}
